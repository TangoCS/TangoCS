namespace System.Web.Services.Description {
    ...
    public sealed class MimeTextMatch {
        ...
        public int Group {
            get { return group; }
            set { 
                if (value < 0) throw new ArgumentException(Res.GetString(Res.S("WebNegativeValue"), "group"));
                group = value; 
            }
        }
        ...
        public int Capture {
            get { return capture; }
            set { 
                if (value < 0) throw new ArgumentException(Res.GetString(Res.S("WebNegativeValue"), "capture"));
                capture = value; 
            }
        }
        ...
        public int Repeats {
            get { return repeats; }
            set { 
                if (value < 0) throw new ArgumentException(Res.GetString(Res.S("WebNegativeValue"), "repeats"));
                repeats = value; 
            }
        }
