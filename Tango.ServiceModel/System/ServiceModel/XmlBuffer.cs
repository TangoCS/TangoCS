...
namespace System.ServiceModel
{
    ...
    class XmlBuffer
    {
        ...
        public XmlBuffer(int maxBufferSize)
        {
            ...
            stream = new BufferManagerOutputStream(Res.S("XmlBufferQuotaExceeded"), initialBufferSize, maxBufferSize,
        ...
        {
            return new InvalidOperationException(Res.GetString(Res.S("XmlBufferInInvalidState")));
        }
