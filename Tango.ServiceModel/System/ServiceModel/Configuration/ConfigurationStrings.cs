...
namespace System.ServiceModel.Configuration
{
    static class ConfigurationStrings
    {
        ...
        {
            get { return GetSectionPath(ConfigurationStrings.BehaviorsSectionName); }
        }

        internal static string BindingsSectionGroupPath
        {
            get { return GetSectionPath(ConfigurationStrings.BindingsSectionGroupName); }
        }

        internal static string ClientSectionPath
        {
            get { return GetSectionPath(ConfigurationStrings.ClientSectionName); }
        }

        internal static string ComContractsSectionPath
        {
            get { return GetSectionPath(ConfigurationStrings.ComContractsSectionName); }
        }

        internal static string CommonBehaviorsSectionPath
        {
            get { return GetSectionPath(ConfigurationStrings.CommonBehaviorsSectionName); }
        }

        internal static string DiagnosticSectionPath
        {
            get { return GetSectionPath(ConfigurationStrings.DiagnosticSectionName); }
        }

        internal static string ExtensionsSectionPath
        {
            get { return GetSectionPath(ConfigurationStrings.Extensions); }
        }

        internal static string ProtocolMappingSectionPath
        {
            get { return GetSectionPath(ConfigurationStrings.ProtocolMappingSectionName); }
        }

        internal static string ServiceHostingEnvironmentSectionPath
        {
            get { return GetSectionPath(ConfigurationStrings.ServiceHostingEnvironmentSectionName); }
        }

        internal static string ServicesSectionPath
        {
            get { return GetSectionPath(ConfigurationStrings.ServicesSectionName); }
        }

        internal static string StandardEndpointsSectionPath
        {
            get { return GetSectionPath(ConfigurationStrings.StandardEndpointsSectionName); }
        }
