	...
	class MessageVersionConverter : TypeConverter
    {
                ...
                switch (messageVersion)
                {
                    ...
                    default:
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("value",
                            Res.GetString(Res.S("ConfigInvalidClassFactoryValue"), messageVersion, typeof(MessageVersion).FullName)));
                }
                return retval;
            }
        ...
        public override object ConvertTo(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value, Type destinationType)
        {
            if (typeof(string) == destinationType && value is MessageVersion)
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("value",
                        Res.GetString(Res.S("ConfigInvalidClassInstanceValue"), typeof(MessageVersion).FullName)));
                }
                return retval;
            }
