...
namespace System.ServiceModel
{
	...
	public class WSHttpBinding : WSHttpBindingBase
    {
        ...
        //            Res.GetString(Res.S("ConfigInvalidBindingConfigurationName"),
        //                         configurationName,
        ...
        public override IChannelFactory<TChannel> BuildChannelFactory<TChannel>(BindingParameterCollection parameters)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("HttpClientCredentialTypeInvalid"), security.Transport.ClientCredentialType)));
            }
        ...
        //            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("WSHttpDoesNotSupportRMWithHttps"))));
        //    }
