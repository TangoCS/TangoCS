...
namespace System.ServiceModel
{
    ...
    public class FaultException : CommunicationException
    {
        ...
        public FaultException()
            : base(Res.GetString(Res.S("SFxFaultReason")))
        {
        ...
        {
            get { return new FaultReason(Res.GetString(Res.S("SFxFaultReason"))); }
        }
        ...
        {
            if (reason == null)
                return Res.GetString(Res.S("SFxUnknownFaultNullReason0"));
            ...
            catch (ArgumentException)
            {
                ...
                {
                    return Res.GetString(Res.S("SFxUnknownFaultZeroReasons0"));
                }
                else
                {
                    return Res.GetString(Res.S("SFxUnknownFaultNoMatchingTranslation1"), reason.Translations[0].Text);
                }
            }
        }
    ...
    public class FaultException<TDetail> : FaultException
    {
        ...
        {
            return Res.GetString(Res.S("SFxFaultExceptionToString3"), this.GetType(), this.Message, this.detail != null ? this.detail.ToString() : String.Empty);
        }
    }
}
