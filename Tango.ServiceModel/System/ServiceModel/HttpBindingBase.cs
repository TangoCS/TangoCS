...
namespace System.ServiceModel
{
	...
	public abstract class HttpBindingBase : Binding, IBindingRuntimePreferences
    {
        ...
        //    {
        //        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(Res.GetString(Res.S("UnsupportedSecuritySetting"), "Mode", mode)));
        //    }
        ...
        //        {
        //            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(Res.GetString(Res.S("UnsupportedSecuritySetting"), "Message.ClientCredentialType", message.ClientCredentialType)));
        //        }
        //    }
        ...
        //    {
        //        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(Res.GetString(Res.S("UnsupportedSecuritySetting"), "Transport.ClientCredentialType", transport.ClientCredentialType)));
        //    }
        //}
    }
}
