...
namespace System.ServiceModel
{
	...
	public sealed class BasicHttpMessageSecurity
    {
        ...
        //        {
        //            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("BasicHttpMessageSecurityRequiresCertificate"))));
        //        }
        ...
        {
			return false; //this.algorithmSuite.GetType() != SecurityAlgorithmSuite.Default.GetType();
        }
