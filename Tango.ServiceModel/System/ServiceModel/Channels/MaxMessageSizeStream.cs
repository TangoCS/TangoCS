...
namespace System.ServiceModel.Channels
{
    ...
    class MaxMessageSizeStream : DelegatingStream
    {
        ...
        {
            string message = Res.GetString(Res.S("MaxReceivedMessageSizeExceeded"), maxMessageSize);
        ...
        {
            string message = Res.GetString(Res.S("MaxSentMessageSizeExceeded"), maxMessageSize);
            Exception inner = new QuotaExceededException(message);
