...
namespace System.ServiceModel.Channels
{
    ...
    sealed class BaseUriWithWildcard
    {
        ...
        BaseUriWithWildcard(string protocol, int defaultPort, string binding, int segmentCount, string path, string sampleBinding)
        {
            ...
            if (urlParameters.Length != segmentCount)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                    new UriFormatException(Res.GetString(Res.S("Hosting_MisformattedBinding"), binding, protocol, sampleBinding)));
            }
            ...
            if (--currentIndex >= 0)
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new UriFormatException(Res.GetString(Res.S("Hosting_MisformattedPort"), protocol, binding, portString)));
                }
            ...
            catch (Exception exception)
            {
                ...
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new UriFormatException(Res.GetString(Res.S("Hosting_MisformattedBindingData"), binding,
                    protocol)));
            }
        ...
        internal static BaseUriWithWildcard CreateHostedUri(string protocol, string binding, string path)
        {
            ...
            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new UriFormatException(Res.GetString(Res.S("Hosting_NotSupportedProtocol"), binding)));
        }
        ...
        internal void OnDeserialized(StreamingContext context)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument("context", Res.GetString(Res.S("Hosting_BaseUriDeserializedNotValid")));
            }
            this.SetComparisonAddressAndHashCode();
        }
        ...
        void SetComparisonAddressAndHashCode()
        {
            ...
            if ((this.comparand.Port == -1) && ((object)this.comparand.Scheme == (object)Uri.UriSchemeNetTcp))
            {
				...
				this.comparand.Port = 808;//TcpUri.DefaultPort;
            }
