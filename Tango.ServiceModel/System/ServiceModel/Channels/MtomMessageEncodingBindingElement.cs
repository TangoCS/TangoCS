	...
	public sealed class MtomMessageEncodingBindingElement : MessageEncodingBindingElement, IWsdlExportExtension, IPolicyExportExtension
    {
        ...
        public MtomMessageEncodingBindingElement(MessageVersion messageVersion, Encoding writeEncoding)
        {
            ...
            if (messageVersion == MessageVersion.None)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(Res.GetString(Res.S("MtomEncoderBadMessageVersion"), messageVersion.ToString()), "messageVersion"));
        ...
        public override MessageVersion MessageVersion
        {
            ...
            set
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(Res.GetString(Res.S("MtomEncoderBadMessageVersion"), value.ToString()), "value"));
                }
