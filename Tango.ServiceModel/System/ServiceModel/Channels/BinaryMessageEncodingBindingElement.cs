	...
	public sealed class BinaryMessageEncodingBindingElement : MessageEncodingBindingElement, IWsdlExportExtension, IPolicyExportExtension
    {
        ...
        public override MessageVersion MessageVersion
        {
            ...
            set
            {
                ...
                {
                    string errorMsg = Res.GetString(Res.S("UnsupportedEnvelopeVersion"), this.GetType().FullName, BinaryEncoderDefaults.EnvelopeVersion, value.Envelope);
        ...
        private void VerifyCompression(BindingContext context)
        {
            if (this.compressionFormat != CompressionFormat.None)
            {
                ...
                {
                    throw FxTrace.Exception.AsError(new NotSupportedException(Res.GetString(
                        Res.S("TransportDoesNotSupportCompression"),
