...
namespace System.ServiceModel.Channels
{
    ...
    public sealed class MessageProperties : IDictionary<string, object>, IDisposable
    {
        ...
        void ThrowDisposed()
        {
            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ObjectDisposedException(string.Empty, Res.GetString(Res.S("ObjectDisposed"), this.GetType().ToString())));
        }
        ...
        public object this[string name]
        {
            get
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(Res.GetString(Res.S("MessagePropertyNotFound"), name)));
                }
        ...
        object CreateCopyOfPropertyValue(object propertyValue)
        {
            ...
            if (copy == null)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(Res.GetString(Res.S("MessagePropertyReturnedNullCopy"))));
            return copy;
        }
        ...
        void UpdateProperty(string name, object value, bool mustNotExist)
        {
            ...
            if (index != NotFoundIndex)
            {
                if (mustNotExist)
                {
                    ...
                    if (exists)
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(Res.GetString(Res.S("DuplicateMessageProperty"), name)));
                    }
                }
        ...
        void ICollection<KeyValuePair<string, object>>.CopyTo(KeyValuePair<string, object>[] array, int index)
        {
            ...
            if (array.Length < propertyCount)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(Res.GetString(Res.S("MessagePropertiesArraySize0"))));
            if (index < 0 || index > array.Length - propertyCount)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("index", index,
                                                    Res.GetString(Res.S("ValueMustBeInRange"), 0, array.Length - propertyCount)));
