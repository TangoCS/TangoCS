...
namespace System.ServiceModel.Channels
{
	...
	abstract class TransportChannelFactory<TChannel> : ChannelFactoryBase<TChannel>, ITransportFactorySettings
    {
            ...
            : base(context.Binding)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("MultipleMebesInParameters"))));
            }
        ...
        internal void ValidateScheme(Uri via)
        {
            if (via.Scheme != this.Scheme)
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument("via", Res.GetString(Res.S("InvalidUriScheme"),
