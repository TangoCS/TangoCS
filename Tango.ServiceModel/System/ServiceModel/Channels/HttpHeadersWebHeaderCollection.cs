       ...
       private static string CheckBadChars(string name, bool isHeaderValue)
        {
            if (name == null || name.Length == 0)
            {
                ...
                if (!isHeaderValue)
                {
                    throw name == null ? 
                        ...
                        new ArgumentException(Res.GetString(Res.S("WebHeaderEmptyStringCall"), "name"), "name");
                }
                ...
                for (int i = 0; i < name.Length; ++i)
                {
                    ...
                    switch (crlf)
                    {
                        case 0:
                            ...
                            {
                                throw new ArgumentException(Res.GetString(Res.S("WebHeaderInvalidControlChars")), "value");
                            }
                        ...
                        case 1:
                            ...
                            throw new ArgumentException(Res.GetString(Res.S("WebHeaderInvalidCRLFChars")), "value");
            ...
            else
            {
                ...
                {
                    throw new ArgumentException(Res.GetString(Res.S("WebHeaderInvalidHeaderChars")), "name");
                }

                // Second, check for non CTL ASCII-7 characters (32-126)
                if (ContainsNonAsciiChars(name))
                {
                    throw new ArgumentException(Res.GetString(Res.S("WebHeaderInvalidNonAsciiChars")), "name");
                }
            }
        ...
        private KeyValuePair<string, IEnumerable<string>> GetHeaderAt(int index)
        {
            ...
            throw new ArgumentOutOfRangeException("index", Res.S("WebHeaderArgumentOutOfRange"));
        }
           ...
           public object Current
            {
                get
                {
                    ...
                    {
                        throw new InvalidOperationException(Res.GetString(Res.S("WebHeaderEnumOperationCantHappen")));
                    }
