    ...
    public class BindingContext
    {
        ...
        BindingElement RemoveNextElement()
        {
            ...
            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(
                Res.S("NoChannelBuilderAvailable"), this.binding.Name, this.binding.Namespace)));
        }
        ...
        internal void ValidateBindingElementsConsumed()
        {
            if (this.RemainingBindingElements.Count != 0)
            {
                ...
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("NotAllBindingElementsBuilt"), builder.ToString())));
            }
        }
    }
}
