...
namespace System.ServiceModel.Channels
{
    ...
    class RequestReplyCorrelator : IRequestReplyCorrelator
    {
        ...
        UniqueId GetRelatesTo(Message reply)
        {
            ...
            if (relatesTo == null)
                throw TraceUtility.ThrowHelperError(new ArgumentException(Res.GetString(Res.S("SuppliedMessageIsNotAReplyItHasNoRelatesTo0"))), reply);
            return relatesTo;
        }
        ...
        internal static void PrepareReply(Message reply, UniqueId messageId)
        {
            if (object.ReferenceEquals(messageId, null))
                throw TraceUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("MissingMessageID"))), reply);
