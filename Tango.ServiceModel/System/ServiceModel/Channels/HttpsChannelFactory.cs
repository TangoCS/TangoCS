...
namespace System.ServiceModel.Channels
{
	...
	class HttpsChannelFactory<TChannel> : HttpChannelFactory<TChannel>
    {
        ...
        //            {
        //                throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument("remoteAddress", Res.GetString(
        //                    Res.S("HttpsIdentityMultipleCerts"), remoteAddress.Uri));
        //            }
        //        }
