...
namespace System.ServiceModel.Channels
{
        ...
        IWsdlExportExtension, IPolicyExportExtension//, ITransportPolicyImport
    {
        ...
        //                new PlatformNotSupportedException(Res.GetString(Res.S("ExtendedProtectionNotSupported"))));
        //        }
            ...
            set
            {
                if (value <= 0)
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("value", value,
                        Res.GetString(Res.S("ValueMustBePositive"))));
                }
        ...
        public int MaxPendingAccepts
        {
            ...
            set
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("value", value,
                        Res.GetString(Res.S("HttpMaxPendingAcceptsTooLargeError"), HttpTransportDefaults.MaxPendingAcceptsUpperLimit)));
                }
        ...
        public AuthenticationSchemes ProxyAuthenticationScheme
        {
            ...
            set
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument("value", Res.GetString(Res.S("HttpProxyRequiresSingleAuthScheme"),
                        value));
                }
        ...
        public TimeSpan RequestInitializationTimeout
        {
            ...
            set
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("value", value, Res.GetString(Res.S("SFxTimeoutOutOfRange0"))));
                }
        ...
        public override bool CanBuildChannelFactory<TChannel>(BindingContext context)
        {
            ...
            {
				return true; //this.WebSocketSettings.TransportUsage != WebSocketTransportUsage.Always;
            }
   ...
   //     }
        ...
        public override IChannelFactory<TChannel> BuildChannelFactory<TChannel>(BindingContext context)
        {
            ...
            {
                throw FxTrace.Exception.AsError(new InvalidOperationException(Res.GetString(Res.S("HttpPipelineNotSupportedOnClientSide"), "MessageHandlerFactory")));
            }

            if (!this.CanBuildChannelFactory<TChannel>(context))
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument("TChannel", Res.GetString(Res.S("CouldnTCreateChannelForChannelType2"), context.Binding.Name, typeof(TChannel)));
            }

            if (this.authenticationScheme == AuthenticationSchemes.None)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument("value", Res.GetString(Res.S("HttpAuthSchemeCannotBeNone"),
...
//"TChannel", Res.GetString(Res.S("CouldnTCreateChannelForChannelType2"), context.Binding.Name, typeof(TChannel)));
//            }
...
//        }
        ...
        protected void UpdateAuthenticationSchemes(BindingContext context)
        {
            ...
            if (effectiveAutheSchemes == AuthenticationSchemes.None)
            {
                ...
                if (this.AuthenticationScheme == AuthenticationSchemes.None)
                {
                    ...
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                        new NotSupportedException(Res.GetString(Res.S("AuthenticationSchemesCannotBeInheritedFromHost"), bindingName)));
                }
                else
                {
                    //settings configured on the host and binding conflict.
                    AuthenticationSchemes hostSchemes = AuthenticationSchemes.None;
                    ...
                    //before the multi-auth feature, in HostedAspNetEnvironment.ValidateHttpSettings.
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                        new NotSupportedException(Res.GetString(Res.S("AuthenticationSchemes_BindingAndHostConflict"), hostSchemes, bindingName, this.AuthenticationScheme)));
                }
            }
   ...
   //                     Res.GetString(Res.S("HttpTransportCannotHaveMultipleAuthenticationSchemes"), policyContext.Contract.Namespace, policyContext.Contract.Name)));
   //             }
   ...
   //         httpAuthAssertions.ForEach(delegate(XmlElement element) { bindingAssertions.Remove(element); });
			...
			//			throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(Res.GetString(
			//					Res.S("WebSocketTransportPolicyAssertionInvalid"),
   ...
   //     }
        ...
        void IWsdlExportExtension.ExportEndpoint(WsdlExporter exporter, WsdlEndpointConversionContext endpointContext)
        {
            ...
            TransportBindingElement.ExportWsdlEndpoint(exporter, endpointContext,
                this.GetWsdlTransportUri(false), address, encodingBindingElement.MessageVersion.Addressing);
        }
