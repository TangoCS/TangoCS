...
namespace System.ServiceModel.Channels
{
    ...
    public abstract class MessageBuffer : /*IXPathNavigable,*/ IDisposable
    {
        ...
        {
            return new ObjectDisposedException("", Res.GetString(Res.S("MessageBufferIsClosed")));
        }
        ...
        //{
        //    if (nodeQuota <= 0)
        //        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("nodeQuota", Res.GetString(Res.S("FilterQuotaRange"))));
