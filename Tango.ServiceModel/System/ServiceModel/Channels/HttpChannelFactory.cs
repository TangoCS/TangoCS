...
namespace System.ServiceModel.Channels
{
        ...
        IHttpTransportFactorySettings
    {
            ...
            : base(bindingElement, context, HttpTransportDefaults.GetDefaultMessageEncoderFactory())
        {
            ...
            if (bindingElement.TransferMode == TransferMode.Buffered)
            {
                if (bindingElement.MaxReceivedMessageSize > int.MaxValue)
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                        ...
                        Res.GetString(Res.S("MaxReceivedMessageSizeMustBeInIntegerRange"))));
                }
                ...
                if (bindingElement.MaxBufferSize != bindingElement.MaxReceivedMessageSize)
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument("bindingElement",
                        Res.GetString(Res.S("MaxBufferSizeMustMatchMaxReceivedMessageSize")));
                }
            }
            else
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument("bindingElement",
                        Res.GetString(Res.S("MaxBufferSizeMustNotExceedMaxReceivedMessageSize")));
                }
            }
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument("bindingElement", Res.GetString(
                    Res.S("HttpAuthDoesNotSupportRequestStreaming")));
            }
            ...
            if (!this.allowCookies)
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("MultipleCCbesInParameters"), typeof(HttpCookieContainerBindingElement))));
                }
                if (httpCookieContainerBindingElements.Count == 1)
                {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument("value", Res.GetString(Res.S("HttpRequiresSingleAuthScheme"),
            ...
            else if (bindingElement.ProxyAddress != null)
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("UseDefaultWebProxyCantBeUsedWithExplicitProxyAddress"))));
                }
            ...
            //        "context", 
            //        Res.GetString(Res.S("MultipleClientWebSocketFactoriesSpecified"), typeof(BindingContext).Name, typeof(ClientWebSocketFactory).Name));
            //}
            //else
            //{
  ...
  //      {
        ...
        {
            return new ArgumentException(Res.GetString(Res.S("HttpToMustEqualVia"), to, via));
        }
        ...
        //    if (spn == null)
        //    {
        //        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new MessageSecurityException(Res.GetString(Res.S("HttpSpnNotFound"),
        ...
        //                    Res.S("WebSocketCannotCreateRequestClientChannelWithCertainWebSocketTransportUsage"),
        //                    typeof(TChannel),
        ...
        //        {
        //            throw FxTrace.Exception.AsError(new PlatformNotSupportedException(Res.GetString(Res.S("WebSocketsClientSideNotSupported"), typeof(ClientWebSocketFactory).FullName)));
        //        }
        //    }
        //}
        ...
        void ApplyManualAddressing(ref EndpointAddress to, ref Uri via, Message message)
        {
            if (ManualAddressing)
            {
                ...
                if (toHeader == null)
                {
                    throw TraceUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("ManualAddressingRequiresAddressedMessages"))), message);
                }
    ...
    //        }
            ...
            //class HttpChannelAsyncRequest : AsyncResult, IAsyncRequest
            //{
            ...
            //            {
            //                throw TraceUtility.ThrowHelperError(new CommunicationObjectAbortedException(Res.GetString(Res.S("HttpRequestAborted"), to.Uri),
            //                    objectDisposedException), this.requestMessage);
            //            }

            //            throw TraceUtility.ThrowHelperError(new TimeoutException(Res.GetString(Res.S("HttpRequestTimedOut"),
            ...
            //                    Res.GetString(Res.S("CredentialDisallowsNtlm"))));
            //            }
            //        }
        ...
        class WebProxyFactory
        {
            ...
            public IWebProxy CreateWebProxy(HttpWebRequest request, SecurityTokenProviderContainer tokenProvider, TimeSpan timeout)
            {
                ...
                if (this.authenticationScheme != AuthenticationSchemes.Anonymous)
                {
                    ...
                    //        Res.S("ProxyImpersonationLevelMismatch"), impersonationLevel, request.ImpersonationLevel)));
                    //}
                    ...
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(
                            Res.S("ProxyAuthenticationLevelMismatch"), authenticationLevel, request.AuthenticationLevel)));
                    }
