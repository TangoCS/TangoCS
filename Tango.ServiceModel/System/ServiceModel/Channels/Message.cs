...
namespace System.ServiceModel.Channels
{
	public abstract class Message : IDisposable
    {
        ...
        public MessageBuffer CreateBufferedCopy(int maxBufferSize)
        {
            if (maxBufferSize < 0)
                throw TraceUtility.ThrowHelperError(new ArgumentOutOfRangeException("maxBufferSize", maxBufferSize,
                                                    Res.GetString(Res.S("ValueMustBeNonNegative"))), this);
            switch (state)
            {
                ...
                case MessageState.Copied:
                    throw TraceUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("MessageHasBeenCopied"))), this);
                case MessageState.Read:
                    throw TraceUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("MessageHasBeenRead"))), this);
                case MessageState.Written:
                    throw TraceUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("MessageHasBeenWritten"))), this);
                default:
                    throw TraceUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("InvalidMessageState"))), this);
            }
        ...
        {
            return new ObjectDisposedException("", Res.GetString(Res.S("MessageClosed")));
        }
        ...
        public XmlDictionaryReader GetReaderAtBodyContents()
        {
            ...
            if (IsEmpty)
                throw TraceUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("MessageIsEmpty"))), this);
        ...
        internal void InitializeReply(Message request)
        {
            ...
            if (requestMessageID == null)
                throw TraceUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("RequestMessageDoesNotHaveAMessageID"))), request);
        ...
        {
            writer.WriteString(Res.GetString(Res.S("MessageBodyIsUnknown")));
        }
        ...
        public override string ToString()
        {
            ...
            {
                return Res.GetString(Res.S("MessageBodyToStringError"), e.GetType().ToString(), e.Message);
            }
        }
    ...
    class XmlReaderBodyWriter : BodyWriter
    {
            ...
            : base(false)
        {
            ...
            if (reader.MoveToContent() != XmlNodeType.Element)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(Res.GetString(Res.S("InvalidReaderPositionOnCreateMessage")), "reader"));
    ...
    class BodyWriterMessage : Message
    {
        ...
        protected override void OnBodyToString(XmlDictionaryWriter writer)
        {
            ...
            {
                writer.WriteString(Res.GetString(Res.S("MessageBodyIsStream")));
            }
        }
    ...
    abstract class ReceivedMessage : Message
    {
            ...
            if (!isEmpty)
            {
                using (XmlDictionaryReader bodyReader = OnGetReaderAtBodyContents())
                {
                    if (bodyReader.ReadState == ReadState.Error || bodyReader.ReadState == ReadState.Closed)
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("MessageBodyReaderInvalidReadState"), bodyReader.ReadState.ToString())));
        ...
        protected static EnvelopeVersion ReadStartEnvelope(XmlDictionaryReader reader)
        {
            ...
            if (reader.IsStartElement(XD.MessageDictionary.Envelope, XD.Message12Dictionary.Namespace))
                ...
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new CommunicationException(Res.GetString(Res.S("MessageVersionUnknown"))));
            if (reader.IsEmptyElement)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new CommunicationException(Res.GetString(Res.S("MessageBodyMissing"))));
            reader.Read();
    ...
    sealed class StreamedMessage : ReceivedMessage
    {
        ...
        public StreamedMessage(XmlDictionaryReader reader, int maxSizeOfHeaders, MessageVersion desiredVersion)
        {
            ...
            else
            {
                ...
                {
                    Exception versionMismatchException = new ArgumentException(Res.GetString(Res.S("EncoderEnvelopeVersionMismatch"), envelopeVersion, desiredVersion.Envelope), "reader");
    ...
    struct XmlAttributeHolder
    {
        ...
        static void Deduct(string s, ref int maxSizeOfHeaders)
        {
            ...
            {
                string message = Res.GetString(Res.S("XmlBufferQuotaExceeded"));
