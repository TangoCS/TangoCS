...
namespace System.ServiceModel.Channels
{
    ...
    //                        new InvalidOperationException(Res.GetString(Res.S("HttpTargetNameDictionaryConflict"), key, value)));
    //                }
    ...
    //        {
    //            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
    //                new SecurityNegotiationException(Res.GetString(Res.S("HttpsServerCertThumbprintMismatch"),
            ...
            where T : SecurityToken
        {
            ...
            if ((result != null) && !(result is T))
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(
                    Res.S("InvalidTokenProvided"), tokenProvider.GetType(), typeof(T))));
            }
            return result as T;
        }
