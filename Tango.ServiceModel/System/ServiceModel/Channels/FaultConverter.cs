    ...
    public abstract class FaultConverter
    {
        ...
        public bool TryCreateException(Message message, MessageFault fault, out Exception exception)
        {
            ...
            if (created)
            {
                if (exception == null)
                {
                    string text = Res.GetString(Res.S("FaultConverterDidNotCreateException"), this.GetType().Name);
            ...
            else
            {
                if (exception != null)
                {
                    string text = Res.GetString(Res.S("FaultConverterCreatedException"), this.GetType().Name);
        ...
        public bool TryCreateFaultMessage(Exception exception, out Message message)
        {
            ...
            if (created)
            {
                if (message == null)
                {
                    string text = Res.GetString(Res.S("FaultConverterDidNotCreateFaultMessage"), this.GetType().Name);
                    Exception error = new InvalidOperationException(text);
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(error);
                }
            }
            else
            {
                if (message != null)
                {
                    string text = Res.GetString(Res.S("FaultConverterCreatedFaultMessage"), this.GetType().Name);
                    Exception error = new InvalidOperationException(text);
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(error);
                }
            }
