...
namespace System.ServiceModel.Channels
{
    ...
    abstract class RequestChannel : ChannelBase, IRequestChannel
    {
        ...
        //            new ArgumentOutOfRangeException("timeout", timeout, Res.GetString(Res.S("SFxTimeoutOutOfRange0"))));
        ...
        //    {
        //        throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument("result", Res.GetString(Res.S("InvalidAsyncResult")));
        //    }
        ...
        public Message Request(Message message, TimeSpan timeout)
        {
            ...
            try
            {
                ...
                {
                    throw TraceUtility.ThrowHelperError(new TimeoutException(Res.GetString(Res.S("RequestChannelSendTimedOut"), savedTimeout),
                ...
                {
                    throw TraceUtility.ThrowHelperError(new TimeoutException(Res.GetString(Res.S("RequestChannelWaitForReplyTimedOut"), savedTimeout),
                        timeoutException), message);
                }
