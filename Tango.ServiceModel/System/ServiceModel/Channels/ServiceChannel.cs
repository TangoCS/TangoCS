...
namespace System.ServiceModel.Channels
{
    ...
    sealed class ServiceChannel : CommunicationObject, IChannel, IClientChannel, /*IDuplexContextChannel,*/ IOutputChannel, IRequestChannel, IServiceChannel
    {
        ...
        public TimeSpan OperationTimeout
        {
            ...
            set
            {
                ...
                {
                    string message = Res.GetString(Res.S("SFxTimeoutOutOfRange0"));
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("value", value, message));
                }
                if (TimeoutHelper.IsTooLarge(value))
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("value", value, Res.GetString(Res.S("SFxTimeoutOutOfRangeTooBig"))));
                }
        ...
        void PrepareCall(ProxyOperationRuntime operation, bool oneway, ref ProxyRpc rpc)
        {
            ...
            //            {
            //                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxCallbackRequestReplyInOrder1"), typeof(ServiceBehaviorAttribute).Name)));
            //            }
            //            else
            //            {
            //                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxCallbackRequestReplyInOrder1"), typeof(CallbackBehaviorAttribute).Name)));
            //            }
            //        }
            //    }
            //}
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxNonInitiatingOperation1"), operation.Name)));
            }

            if (this.terminatingOperationName != null)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxTerminatingOperationAlreadyCalled1"), this.terminatingOperationName)));
            }

            //if (this.hasChannelStartedAutoClosing)
            //{
            //    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ProtocolException(Res.GetString(Res.S("SFxClientOutputSessionAutoClosed"))));
            //}
            ...
            if (!oneway && !this.ClientRuntime.ManualAddressing && rpc.Request.Version.Addressing != AddressingVersion.None)
            {
                ...
                if (this.IsClient && (localAddress != null) && !localAddress.IsAnonymous)
                {
                    ...
                    {
                        string text = Res.GetString(Res.S("SFxRequestHasInvalidReplyToOnClient"), replyTo.Uri, localUri);
                    ...
                    {
                        string text = Res.GetString(Res.S("SFxRequestHasInvalidFaultToOnClient"), faultTo.Uri, localUri);
                        Exception error = new InvalidOperationException(text);
                        throw TraceUtility.ThrowHelperError(error, rpc.Request);
                    }
                    ...
                    if (this.messageVersion.Addressing == AddressingVersion.WSAddressingAugust2004)
                    {
                        ...
                        {
                            string text = Res.GetString(Res.S("SFxRequestHasInvalidFromOnClient"), from.Uri, localUri);
                            Exception error = new InvalidOperationException(text);
                            throw TraceUtility.ThrowHelperError(error, rpc.Request);
                        }
                    }
        ...
        internal object Call(string action, bool oneway, ProxyOperationRuntime operation, object[] ins, object[] outs, TimeSpan timeout)
        {
			...
			try
			{
				...
				else
				{
					...
					{
						this.ThrowIfFaulted();
						throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new CommunicationException(Res.GetString(Res.S("SFxServerDidNotReply"))));
					}
				}
			}
			finally
  ...
  //          if (sendResult == null)
  //              throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(Res.GetString(Res.S("SFxInvalidCallbackIAsyncResult"))));


		//	if (sendResult.Rpc.Channel != this)
		//		throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument("result", Res.GetString(Res.S("AsyncEndCalledOnWrongChannel")));

		//	if (action != MessageHeaders.WildcardAction && action != sendResult.Rpc.Action)
		//		throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument("result", Res.GetString(Res.S("AsyncEndCalledWithAnIAsyncResult")));
        ...
        TimeoutException GetOpenTimeoutException(TimeSpan timeout)
        {
            ...
            if (address != null)
            {
                return new TimeoutException(Res.GetString(Res.S("TimeoutServiceChannelConcurrentOpen2"), address, timeout));
            }
            else
            {
                return new TimeoutException(Res.GetString(Res.S("TimeoutServiceChannelConcurrentOpen1"), timeout));
            }
        }
            ...
            try
            {
                if (rpc.Reply != null)
                {
                    ...
                    if ((operation.ReplyAction != MessageHeaders.WildcardAction) && !rpc.Reply.IsFault && rpc.Reply.Headers.Action != null)
                    {
                        ...
                        {
                            Exception error = new ProtocolException(Res.GetString(Res.S("SFxReplyActionMismatch3"),
                                                                                  operation.Name,
        ...
        void ThrowIfIdleAborted(ProxyOperationRuntime operation)
        {
            ...
            //{
            //    string text = Res.GetString(Res.S("SFxServiceChannelIdleAborted"), operation.Name);
        ...
        void ThrowIfIsConnectionOpened(ProxyOperationRuntime operation)
        {
            if (operation.IsSessionOpenNotificationEnabled)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(
                    Res.GetString(Res.S("SFxServiceChannelCannotBeCalledBecauseIsSessionOpenNotificationEnabled"), operation.Name, "Action", OperationDescription.SessionOpenedAction, "Open")));
            }
        }
        ...
        void ThrowIfInitializationUINotCalled()
        {
            if (!this.didInteractiveInitialization && (this.ClientRuntime.InteractiveChannelInitializers.Count > 0))
            {
                ...
                string text = Res.GetString(Res.S("SFxInitializationUINotCalled"), example.GetType().ToString());
                Exception error = new InvalidOperationException(text);
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(error);
            }
        }
        ...
        void ThrowIfDisallowedInitializationUICore()
        {
            ...
            {
                IInteractiveChannelInitializer example = this.ClientRuntime.InteractiveChannelInitializers[0];
                string text = Res.GetString(Res.S("SFxInitializationUIDisallowed"), example.GetType().ToString());
                Exception error = new InvalidOperationException(text);
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(error);
            }
        }
        ...
        void ThrowIfOpening()
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxCannotCallAutoOpenWhenExplicitOpenCalled"))));
            }
        }
		...
		void AddMessageProperties(Message message, OperationContext context)
		{
			...
			if (context != null && context.InternalServiceChannel == this)
			{
				...
				{
					throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(
						Res.GetString(Res.S("SFxVersionMismatchInOperationContextAndMessage2"), context.OutgoingMessageVersion, message.Headers.MessageVersion)
						));
				}
        ...
        //    {
        //        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("channelIsNotAvailable0"))));
        //    }

        //    ISessionChannel<IDuplexSession> duplexSessionChannel = this.InnerChannel as ISessionChannel<IDuplexSession>;
        //    if (duplexSessionChannel == null)
        //    {
        //        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("channelDoesNotHaveADuplexSession0"))));
        //    }
        ...
        //                Res.GetString(Res.S("TraceCodeServiceChannelLifetime")),
