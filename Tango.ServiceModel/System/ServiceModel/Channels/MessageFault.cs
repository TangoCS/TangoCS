...
namespace System.ServiceModel.Channels
{
	...
	public abstract class MessageFault
    {
        ...
        public static MessageFault CreateFault(Message message, int maxBufferSize)
        {
            ...
            using (reader)
            {
                try
                {
                    ...
                    {
                        throw TraceUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("EnvelopeVersionUnknown"), envelopeVersion.ToString())), message);
                    }
                ...
                catch (InvalidOperationException e)
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new CommunicationException(
                        Res.GetString(Res.S("SFxErrorDeserializingFault")), e));
                }
        ...
        public T GetDetail<T>(XmlObjectSerializer serializer)
        {
            ...
            if (!reader.EOF)
            {
                ...
                if (reader.NodeType != XmlNodeType.EndElement && !reader.EOF)
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new FormatException(Res.GetString(Res.S("ExtraContentIsPresentInFaultDetail"))));
            }
            return value;
        }
        ...
        {
            if (!HasDetail)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("FaultDoesNotHaveAnyDetail"))));
        ...
        public void WriteTo(XmlDictionaryWriter writer, EnvelopeVersion version)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("EnvelopeVersionUnknown"), version.ToString())));
            }
        }
    ...
    class ReceivedFault : MessageFault
    {
        ...
        static ReceivedFault CreateFault12Driver(XmlDictionaryReader reader, int maxBufferSize, EnvelopeVersion version)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new FormatException(Res.GetString(Res.S("AtLeastOneFaultReasonMustBeSpecified"))));
            }
            else
            {
