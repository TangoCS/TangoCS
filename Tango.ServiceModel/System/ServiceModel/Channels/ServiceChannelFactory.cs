    ...
    abstract class ServiceChannelFactory : ChannelFactoryBase
    {
        ...
        public static ServiceChannelFactory BuildChannelFactory(ServiceEndpoint serviceEndpoint, bool useActiveAutoClose)
        {
            ...
            foreach (Type type in requiredChannels)
            {
                ...
                //            Res.GetString(Res.S("CantCreateChannelWithManualAddressing"))));
                //    }
		...
		//	{
		//		throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(
		//			Res.GetString(Res.S("CouldnTCreateChannelForChannelType2"), this.bindingName, typeof(TChannel).Name)));
		//	}

		//	return this.CreateChannel<TChannel>(typeof(TChannel), address, via);
		//}

		public abstract bool CanCreateChannel<TChannel>();

		//public TChannel CreateChannel<TChannel>(Type channelType, EndpointAddress address)
		//{
		//	return this.CreateChannel<TChannel>(channelType, address, null);
		//}
		...
		public TChannel CreateChannel<TChannel>(EndpointAddress address, Uri via)
        {
            ...
            serviceChannel.Proxy = ServiceChannelProxy.CreateProxy<TChannel>(MessageDirection.Input, serviceChannel);
        ...
        internal static object CreateProxy(Type interfaceType, Type proxiedType, MessageDirection direction, ServiceChannel serviceChannel)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString("SFxChannelFactoryTypeMustBeInterface")));
            }
