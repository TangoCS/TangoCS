...
namespace System.ServiceModel
{
	...
	public class MessageSecurityOverHttp
    {
        ...
        //    {
        //        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SecureConversationRequiredByReliableSession"))));
        //    }
        ...
        //                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("ClientCredentialTypeMustBeSpecifiedForMixedMode"))));
        ...
        {
			return false;// this.AlgorithmSuite != SecurityAlgorithmSuite.Default;
        }
