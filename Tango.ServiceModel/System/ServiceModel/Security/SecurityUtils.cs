...
//    }
    ...
    static class SecurityUtils
    {
		...
		//                        if (result != null)
		//                        {
		//                            throw DiagnosticUtility.ExceptionUtility.ThrowHelperWarning(new MessageSecurityException(Res.GetString(Res.S("MultipleMatchingCryptosFound"), typeof(T).ToString())));
		//                        }
		//                        else
		//                        {
		//                            result = temp;
		...
		//            {
		//                throw System.ServiceModel.Diagnostics.TraceUtility.ThrowHelperError(new MessageSecurityException(Res.GetString(Res.S("TokenNotExpectedInSecurityHeader"), t2)), message);
		//            }
		//        }
		...
		//            {
		//                throw DiagnosticUtility.ExceptionUtility.ThrowHelperWarning(new MessageSecurityException(Res.GetString(Res.S("CannotFindMatchingCrypto"), encryptionMethod)));
		//            }
		...
		//            {
		//                throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument(Res.GetString(Res.S("CannotFindMatchingCrypto"), encryptionMethod));
		//            }
		...
		//                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new QuotaExceededException(Res.GetString(Res.S("BufferQuotaExceededReadingBase64"), maxBufferSize)));
		//                totalRead += read;
		...
		//            {
		//                throw DiagnosticUtility.ExceptionUtility.ThrowHelperWarning(new MessageSecurityException(Res.GetString(Res.S("CannotFindMatchingCrypto"), derivationAlgorithm)));
		//            }
		...
		//            if (!foundSpn)
		//            {
		//                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new MessageSecurityException(Res.GetString(Res.S("CannotDetermineSPNBasedOnAddress"), target)));
		//            }
		//            return spn;
		//        }
		...
		//            if (!canDoKeyExchange)
		//            {
		//                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(Res.GetString(Res.S("SslCertMayNotDoKeyExchange"), certificate.SubjectName.Name), innerException));
		//            }
		//        }
		...
		//                    {
		//                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ServerTooBusyException(Res.GetString(Res.S("SecurityServerTooBusy"), target), faultException));
		//                    }
		//                    else if (subCode.Name == AddressingStrings.EndpointUnavailable && subCode.Namespace == message.Version.Addressing.Namespace)
		//                    {
		//                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new EndpointNotFoundException(Res.GetString(Res.S("SecurityEndpointNotFound"), target), faultException));
		//                    }
		//                }
		...
		//            return new MessageSecurityException(Res.GetString(Res.S("UnsecuredMessageFaultReceived")), faultException);
		//        }
		...
		//            if (action != null)
		//            {
		//                reason = new FaultReason(Res.GetString(Res.S("BadContextTokenOrActionFaultReason"), action), CultureInfo.CurrentCulture);
		//            }
		//            else
		//            {
		//                reason = new FaultReason(Res.GetString(Res.S("BadContextTokenFaultReason")), CultureInfo.CurrentCulture);
		//            }
		...
		//                reason = new FaultReason(Res.GetString(Res.S("FailedAuthenticationFaultReason")), CultureInfo.CurrentCulture);
		//            }
		//            else if (isGenericTokenError)
		//            {
		//                subCode = new FaultCode(wss.InvalidSecurityTokenFaultCode.Value, wss.HeaderNamespace.Value);
		//                reason = new FaultReason(Res.GetString(Res.S("InvalidSecurityTokenFaultReason")), CultureInfo.CurrentCulture);
		//            }
		...
		//                reason = new FaultReason(Res.GetString(Res.S("InvalidSecurityFaultReason")), CultureInfo.CurrentCulture);
		//            }
		//            FaultCode senderCode = FaultCode.CreateSenderFaultCode(subCode);
		//            return MessageFault.CreateFault(senderCode, reason);
		//        }
		...
		//            {
		//                throw TraceUtility.ThrowHelperWarning(new SecurityNegotiationException(Res.GetString(Res.S("RequestSecurityTokenDoesNotMatchEndpointFilters"), listenUri)), rst);
		//            }
		//        }
		...
		//            if (certificate == null)
		//                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("CannotFindCert"), storeName, storeLocation, findType, findValue)));
		...
		//                if (target == null)
		//                {
		//                    return new InvalidOperationException(Res.GetString(Res.S("CannotFindCert"), storeName, storeLocation, findType, findValue));
		//                }
		//                else
		//                {
		//                    return new InvalidOperationException(Res.GetString(Res.S("CannotFindCertForTarget"), storeName, storeLocation, findType, findValue, target));
		//                }
		//            }
		//            else
		//            {
		//                if (target == null)
		//                {
		//                    return new InvalidOperationException(Res.GetString(Res.S("FoundMultipleCerts"), storeName, storeLocation, findType, findValue));
		//                }
		//                else
		//                {
		//                    return new InvalidOperationException(Res.GetString(Res.S("FoundMultipleCertsForTarget"), storeName, storeLocation, findType, findValue, target));
		//                }
		//            }
		//        }
		...
		//            if (binding == null)
		//            {
		//                throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument(Res.GetString(Res.S("IssuerBindingNotPresentInTokenRequirement"), requirement));
		//            }
		...
		//                    new SecurityTokenValidationException(Res.GetString(Res.S("AnonymousLogonsAreNotAllowed"))));
		//            }
		//        }
		...
		//            {
		//                throw DiagnosticUtility.ExceptionUtility.ThrowHelperWarning(new SecurityNegotiationException(Res.GetString(Res.S("SslCipherKeyTooSmall"), keySizeInBits, MinimumSslCipherStrength)));
		//            }
		//        }
