...
namespace System.ServiceModel
{
    ...
    public abstract class ChannelFactory : CommunicationObject, IChannelFactory, IDisposable
    {
		...
		//	if (this.Endpoint == null)
		//	{
		//		throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxChannelFactoryCannotApplyConfigurationWithoutEndpoint"))));
		//	}
        ...
        internal EndpointAddress CreateEndpointAddress(ServiceEndpoint endpoint)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxChannelFactoryEndpointAddressUri"))));
            }
        ...
        protected virtual IChannelFactory CreateFactory()
        {
            if (this.Endpoint == null)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxChannelFactoryCannotCreateFactoryWithoutDescription"))));
            }
        ...
        protected override void OnOpening()
        {
            ...
            if (this.innerFactory == null)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("InnerChannelFactoryWasNotSet"))));
        }
    }
    ...
    public class ChannelFactory<TChannel> : ChannelFactory, IChannelFactory<TChannel>
    {
            ...
            : base()
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxChannelFactoryTypeMustBeInterface"))));
            }
  ...
  //      {
		...
		//		{
		//			ServiceModelActivity.Start(activity, Res.GetString(Res.S("ActivityConstructChannelFactory"), typeof(TChannel).FullName), ActivityType.Construct);
		//		}
        ...
        {
            get { return Res.GetString(Res.S("ActivityCloseChannelFactory"), typeof(TChannel).FullName); }
        }

        internal override string OpenActivityName
        {
            get { return Res.GetString(Res.S("ActivityOpenChannelFactory"), typeof(TChannel).FullName); }
        }
        ...
        public virtual TChannel CreateChannel(EndpointAddress address, Uri via)
        {
            ...
            try
            {
				...
				{
					throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxCreateNonDuplexChannel1"), this.Endpoint.Contract.Name)));
				}

				EnsureOpened();
				return this.ServiceChannelFactory.CreateChannel<TChannel>(address, via);
			}
            finally
            {
        ...
        //        {
        //            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SfxCallbackTypeCannotBeNull"), endpoint.Contract.ContractType.FullName)));
        //        }
        ...
        //    {
        //        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxInvalidStaticOverloadCalledForDuplexChannelFactory1"), channelFactory.channelType.Name)));
        //    }
