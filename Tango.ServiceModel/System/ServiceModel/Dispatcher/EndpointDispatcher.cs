...
namespace System.ServiceModel.Dispatcher
{
    ...
    //            return builder.ToEndpointAddress();
        ...
        //    if (this.channelDispatcher != null)
        //    {
        //        Exception error = new InvalidOperationException(Res.GetString(Res.S("SFxEndpointDispatcherMultipleChannelDispatcher0")));
        ...
        //    {
        //        Exception error = new InvalidOperationException(Res.GetString(Res.S("SFxEndpointDispatcherDifferentChannelDispatcher0")));
        //        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(error);
        //    }
