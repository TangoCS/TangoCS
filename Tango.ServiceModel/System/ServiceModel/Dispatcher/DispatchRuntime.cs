     ...
     //   }
		...
		internal bool EnableFaults {
			get {
				if (this.IsOnServer)
				{
					...
					return false;//(channelDispatcher != null) && channelDispatcher.EnableFaults;
				}
				else
				{
        ...
        internal bool ManualAddressing
        {
            get
            {
                ...
                {
                    //ChannelDispatcher channelDispatcher = this.ChannelDispatcher;
                    return false; //(channelDispatcher != null) && channelDispatcher.ManualAddressing;
                }
                else
                {
        ...
        internal void LockDownProperties()
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SfxDispatchRuntimeNonConcurrentOrEnsureOrderedDispatch"))));
            }
        }
        ...
        internal class UnhandledActionInvoker : IOperationInvoker
        {
            ...
            public object Invoke(object instance, object[] inputs, out object[] outputs)
            {
                ...
                string reasonText = Res.GetString(Res.S("SFxNoEndpointMatchingContract"), action);
        ...
        class OperationCollection : SynchronizedKeyedCollection<string, DispatchOperation>
        {
            ...
            protected override void InsertItem(int index, DispatchOperation item)
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument(Res.GetString(Res.S("SFxMismatchedOperationParent")));
                }
        ...
        //    {
        //        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxCannotActivateCallbackInstace"))));
        //    }

        //    object IInstanceProvider.GetInstance(InstanceContext instanceContext, Message message)
        //    {
        //        throw TraceUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxCannotActivateCallbackInstace"))), message);
        //    }
