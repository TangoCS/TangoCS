            ...
            if (TryMatchCandidateSet(to, false/*includeHostNameInComparison*/, out cset))
            {
                ...
                if (c != null)
                {
                    if (can != null)
                    {
                        ...
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new MultipleFilterMatchesException(Res.GetString(Res.S("FilterMultipleMatches")), null, matches));
                    }
                    can = c;
                }
            }
        ...
        Candidate GetSingleMatch(CandidateSet cset, Message message)
        {
            ...
            if (cset.qnames.Count == 0)
            {
                ...
                else
                {
                    ...
                    throw TraceUtility.ThrowHelperError(new MultipleFilterMatchesException(Res.GetString(Res.S("FilterMultipleMatches")), null, matches), message);
                }
            }
