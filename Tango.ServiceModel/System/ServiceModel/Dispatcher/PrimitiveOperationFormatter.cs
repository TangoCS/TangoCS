...
namespace System.ServiceModel.Dispatcher
{
	...
	class PrimitiveOperationFormatter : IClientMessageFormatter, IDispatchMessageFormatter
    {
        ...
        ActionHeader GetActionHeader(AddressingVersion addressing)
        {
            ...
            else
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                    new InvalidOperationException(Res.GetString(Res.S("AddressingVersionNotSupported"), addressing)));
            }
        }
        ...
        static string GetArrayItemName(Type type)
        {
            switch (Type.GetTypeCode(type))
            {
                ...
                case TypeCode.Double:
                    return "double";
                default:
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxInvalidUseOfPrimitiveOperationFormatter"))));
            }
        }
        ...
        static bool IsTypeSupported(MessagePartDescription bodyDescription)
        {
            ...
            if (type == null)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxMessagePartDescriptionMissingType"), bodyDescription.Name, bodyDescription.Namespace)));
        ...
        public object DeserializeReply(Message message, object[] parameters)
        {
            ...
            try
            {
                if (message.IsEmpty)
                {
                    if (responseWrapperName == null)
                        return null;
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new SerializationException(Res.GetString(Res.S("SFxInvalidMessageBodyEmptyMessage"))));
                }
            ...
            catch (XmlException xe)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new CommunicationException(
                    Res.GetString(Res.S("SFxErrorDeserializingReplyBodyMore"), operation.Name, xe.Message), xe));
            }
            catch (FormatException fe)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new CommunicationException(
                    Res.GetString(Res.S("SFxErrorDeserializingReplyBodyMore"), operation.Name, fe.Message), fe));
            }
            catch (SerializationException se)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new CommunicationException(
                    Res.GetString(Res.S("SFxErrorDeserializingReplyBodyMore"), operation.Name, se.Message), se));
            }
        }
            ...
            catch (XmlException xe)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                    OperationFormatter.CreateDeserializationFailedFault(
                        Res.GetString(Res.S("SFxErrorDeserializingRequestBodyMore"), operation.Name, xe.Message), 
                        xe));
            }
            catch (FormatException fe)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                    OperationFormatter.CreateDeserializationFailedFault(
                        Res.GetString(Res.S("SFxErrorDeserializingRequestBodyMore"), operation.Name, fe.Message), 
                        fe));
            }
            catch (SerializationException se)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new CommunicationException(
                    Res.GetString(Res.S("SFxErrorDeserializingRequestBodyMore"), operation.Name, se.Message), 
                    se));
            }
        }
        ...
        void DeserializeRequest(XmlDictionaryReader reader, object[] parameters)
        {
            if (requestWrapperName != null)
            {
                if (!reader.IsStartElement(requestWrapperName, requestWrapperNamespace))
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new SerializationException(Res.GetString(Res.S("SFxInvalidMessageBody"), requestWrapperName, requestWrapperNamespace, reader.NodeType, reader.Name, reader.NamespaceURI)));
        ...
        object DeserializeResponse(XmlDictionaryReader reader, object[] parameters)
        {
            if (responseWrapperName != null)
            {
                if (!reader.IsStartElement(responseWrapperName, responseWrapperNamespace))
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new SerializationException(Res.GetString(Res.S("SFxInvalidMessageBody"), responseWrapperName, responseWrapperNamespace, reader.NodeType, reader.Name, reader.NamespaceURI)));
                bool isEmptyElement = reader.IsEmptyElement;
                reader.Read();
                if (isEmptyElement)
                {
        ...
        void DeserializeParameters(XmlDictionaryReader reader, PartInfo[] parts, object[] parameters)
        {
            if (parts.Length != parameters.Length)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                    new ArgumentException(Res.GetString(Res.S("SFxParameterCountMismatch"), "parts", parts.Length, "parameters", parameters.Length), "parameters"));
