...
namespace System.ServiceModel.Dispatcher
{
	...
	abstract class OperationFormatter : IClientMessageFormatter, IDispatchMessageFormatter
    {
        ...
        public object DeserializeReply(Message message, object[] parameters)
        {
            ...
            catch (XmlException xe)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new CommunicationException(
                    Res.GetString(Res.S("SFxErrorDeserializingReplyBodyMore"), this.operationName, xe.Message), xe));
            }
            catch (FormatException fe)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new CommunicationException(
                    Res.GetString(Res.S("SFxErrorDeserializingReplyBodyMore"), this.operationName, fe.Message), fe));
            }
            catch (SerializationException se)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new CommunicationException(
                    Res.GetString(Res.S("SFxErrorDeserializingReplyBodyMore"), this.operationName, se.Message), se));
            }
        }
        ...
        private static object CreateTypedMessageInstance(Type messageContractType)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxMessageContractRequiresDefaultConstructor"), messageContractType.FullName), mme));
            }
        }
            ...
            catch (XmlException xe)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                    OperationFormatter.CreateDeserializationFailedFault(
                        Res.GetString(Res.S("SFxErrorDeserializingRequestBodyMore"), this.operationName, xe.Message), 
                        xe));
            }
            catch (FormatException fe)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                    OperationFormatter.CreateDeserializationFailedFault(
                        Res.GetString(Res.S("SFxErrorDeserializingRequestBodyMore"), this.operationName, fe.Message), 
                        fe));
            }
            catch (SerializationException se)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new CommunicationException(
                    Res.GetString(Res.S("SFxErrorDeserializingRequestBodyMore"), this.operationName, se.Message), 
                    se));
            }
        }
        ...
        internal static void Validate(OperationDescription operation, bool isRpc, bool isEncoded)
        {
            if (isEncoded && !isRpc)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxDocEncodedNotSupported"), operation.Name)));
            }
            ...
            for (int i = 0; i < operation.Messages.Count; i++)
            {
                ...
                if (message.IsTypedMessage || message.IsUntypedMessage)
                {
                    ...
                    {
                        if (!isEncoded)
                            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxTypedMessageCannotBeRpcLiteral"), operation.Name)));
            ...
            if (hasParameter && hasTypedOrUntypedMessage)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxTypedOrUntypedMessageCannotBeMixedWithParameters"), operation.Name)));
            if (isRpc && hasTypedOrUntypedMessage && hasVoid)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxTypedOrUntypedMessageCannotBeMixedWithVoidInRpc"), operation.Name)));
        }
        ...
        {
            reason = Res.GetString(Res.S("SFxDeserializationFailed1"), reason);
        ...
        class TypedMessageParts
        {
            ...
            public TypedMessageParts(object instance, MessageDescription description)
            {
                ...
                if (instance == null)
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentNullException(Res.GetString(Res.S("SFxTypedMessageCannotBeNull"), description.Action)));
                }
