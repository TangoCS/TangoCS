...
namespace System.ServiceModel
{
	...
	public abstract class EndpointIdentity
    {
        ...
        //        throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument(Res.GetString(Res.S("X509ChainIsEmpty")));
        ...
        internal static EndpointIdentity ReadIdentity(XmlDictionaryReader reader)
        {
            ...
            if (reader.IsEmptyElement)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new XmlException(Res.GetString(Res.S("UnexpectedEmptyElementExpectingClaim"), XD.AddressingDictionary.Identity.Value, XD.AddressingDictionary.IdentityExtensionNamespace.Value)));
            ...
            //    else
            //    {
            //        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new XmlException(Res.GetString(Res.S("UnrecognizedIdentityType"), reader.Name, reader.NamespaceURI)));
            //    }
            ...
            //    //
            //    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new XmlException(Res.GetString(Res.S("InvalidIdentityElement"))));
            //}
        ...
        {
            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException("UnrecognizedIdentityPropertyType"));
        }
