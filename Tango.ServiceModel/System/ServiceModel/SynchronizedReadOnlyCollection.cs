...
namespace System.Collections.Generic
{
    ...
    public class SynchronizedReadOnlyCollection<T> : IList<T>, IList
    {
        ...
        void ThrowReadOnly()
        {
            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(Res.GetString(Res.S("SFxCollectionReadOnly"))));
        }
        ...
        void ICollection.CopyTo(Array array, int index)
        {
            ...
            if (asCollection == null)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(Res.GetString(Res.S("SFxCopyToRequiresICollection"))));
        ...
        static void VerifyValueType(object value)
        {
            ...
            string message = Res.GetString(Res.S("SFxCollectionWrongType2"), type.ToString(), typeof(T).ToString());
