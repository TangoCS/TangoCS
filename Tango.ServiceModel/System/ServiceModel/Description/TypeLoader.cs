...
namespace System.ServiceModel.Description
{
    ...
    class TypeLoader
    {
                ...
                for (Type service = actualContractType.BaseType; service != null; service = service.BaseType)
                {
                    if (ServiceReflector.GetSingleAttribute<ServiceContractAttribute>(service) != null)
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(
                            Res.GetString(Res.S("SFxContractInheritanceRequiresInterfaces"), actualContractType, service)));
                    }
                }
            }
        }
                    ...
                    if (operationContractProviderType != null)
                    {
                        if (operationContractProviderType == OperationContractAttributeType)
                        {
                            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(
                                Res.S("SFxOperationContractOnNonServiceContract"), methodInfo.Name, aParentType.Name)));
                        }
                        else
                        {
                            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(
                                Res.S("SFxOperationContractProviderOnNonServiceContract"), operationContractProviderType.Name, methodInfo.Name, aParentType.Name)));
                        }
                    }
                }
            }
        ...
        private IEnumerable<Type> GetKnownTypes(object[] knownTypeAttributes, ICustomAttributeProvider provider)
        {
            if (knownTypeAttributes.Length == 1)
            {
                ...
                if (!string.IsNullOrEmpty(knownTypeAttribute.MethodName))
                {
                    ...
                    if (method == null)
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxKnownTypeAttributeUnknownMethod3"), provider, knownTypeAttribute.MethodName, type.FullName)));

                    if (!typeof(IEnumerable<Type>).IsAssignableFrom(method.ReturnType))
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxKnownTypeAttributeReturnType3"), provider, knownTypeAttribute.MethodName, type.FullName)));
            ...
            for (int i = 0; i < knownTypeAttributes.Length; ++i)
            {
                ...
                if (knownTypeAttribute.Type == null)
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxKnownTypeAttributeInvalid1"), provider.ToString())));
                ...
                else
                {
                    if (opDesc.SyncMethod != null && opDesc.BeginMethod != null)
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                            new InvalidOperationException(Res.GetString(Res.S("SyncAsyncMatchConsistency_Attributes6"),
                    ...
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                            new InvalidOperationException(Res.GetString(Res.S("SyncTaskMatchConsistency_Attributes6"),
                                                                       opDesc.SyncMethod.Name,
                                                                       opDesc.SyncMethod.DeclaringType,
                    ...
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                            new InvalidOperationException(Res.GetString(Res.S("TaskAsyncMatchConsistency_Attributes6"),
                                                                       opDesc.TaskMethod.Name,
                                         ...
                                         )
        {
            ...
            foreach (MethodInfo methodInfo in contractToGetMethodsFrom.GetMethods(DefaultBindingFlags))
            {
                if (contractToGetMethodsFrom.IsInterface)
                {
                    ...
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(
                            Res.GetString(Res.S("SFxOperationBehaviorAttributeOnlyOnServiceClass"), methodInfo.Name, contractToGetMethodsFrom.Name)));
                    }
                }
        ...
        internal static void EnsureCallbackType(Type callbackType)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(Res.GetString(Res.S("SFxInvalidCallbackContractType"), callbackType.Name)));
            }
        }
        ...
        internal static void EnsureSubcontract(ServiceContractAttribute svcContractAttr, Type contractType)
        {
            ...
            for (int i = 0; i < types.Count; i++)
            {
                ...
                if (inheritedContractAttr.CallbackContract != null)
                {
                    ...
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(
                            Res.GetString(Res.S("InAContractInheritanceHierarchyIfParentHasCallbackChildMustToo"),
                    ...
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(
                            Res.GetString(Res.S("InAContractInheritanceHierarchyTheServiceContract3_2"),
                ...
                foreach (OperationDescription op in inheritedContractDescription.Operations)
                {
                    if (!contractDescription.Operations.Contains(op)) // in a diamond hierarchy, ensure we don't add same op twice from two different parents
                    {
                        ...
                        foreach (OperationDescription existingOp in existingOps)
                        {
                            ...
                            {
                                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(
                                    Res.GetString(Res.S("CannotInheritTwoOperationsWithTheSameName3"),
                                                        ...
                                                        ContractReflectionInfo reflectionInfo, ContractDescription declaringContract)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(
                    Res.GetString(Res.S("EndMethodsCannotBeDecoratedWithOperationContractAttribute"),
            ...
            for (int i = 0; i < operations.Count; i++)
            {
                ...
                if (existingOp.Messages[0].Direction == direction)
                {
                    ...
                    if (existingOp.TaskMethod != null && isTask)
                    {
                        ...
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("CannotHaveTwoOperationsWithTheSameName3"), method1Name, method2Name, reflectionInfo.iface)));
                    }
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("OneWayAndFaultsIncompatible2"), methodInfo.DeclaringType.FullName, operationName.EncodedName)));
            }
            ...
            else
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("ServiceOperationsMarkedWithIsOneWayTrueMust0"))));
                }

                if (opAttr.ReplyAction != null)
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("OneWayOperationShouldNotSpecifyAReplyAction1"), operationName)));
                }
            }
        ...
        private void CheckDuplicateFaultContract(FaultDescriptionCollection faultDescriptionCollection, FaultDescription fault, string operationName)
        {
            foreach (FaultDescription existingFault in faultDescriptionCollection)
            {
                if (XmlName.IsNullOrEmpty(existingFault.ElementName) && XmlName.IsNullOrEmpty(fault.ElementName) && existingFault.DetailType == fault.DetailType)
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(
                        Res.GetString(Res.S("SFxFaultContractDuplicateDetailType"), operationName, fault.DetailType)));
                if (!XmlName.IsNullOrEmpty(existingFault.ElementName) && !XmlName.IsNullOrEmpty(fault.ElementName) && existingFault.ElementName == fault.ElementName && existingFault.Namespace == fault.Namespace)
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(
                        Res.GetString(Res.S("SFxFaultContractDuplicateElement"), operationName, fault.ElementName, fault.Namespace)));
            }
        }
                                                           ...
                                                           MessageDirection direction)
        {
            ...
            for (int i = 0; i < messageDescription.Headers.Count; i++)
            {
                ...
                if (header.IsUnknownHeaderCollection)
                {
                    ...
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxMultipleUnknownHeaders"), methodInfo, methodInfo.DeclaringType)));
                    }
                    else
                    {
                                                  ...
                                                  MessageDirection direction)
        {
            foreach (ParameterInfo param in parameters)
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxInvalidMessageContractSignature"), methodName)));
                }
            }
            ...
            for (int index = 0; index < parameters.Length; index++)
            {
                ...
                if (partDescriptionCollection.Contains(new XmlQualifiedName(partDescription.Name, partDescription.Namespace)))
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidMessageContractException(Res.GetString(Res.S("SFxDuplicateMessageParts"), partDescription.Name, partDescription.Namespace)));
                                                  ...
                                                  MessageDirection direction)
        {
            ...
            for (Type baseType = typedMessageType; baseType != null && baseType != typeof(object) && baseType != typeof(ValueType); baseType = baseType.BaseType)
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxMessageContractBaseTypeNotValid"), baseType, typedMessageType)));
                }
                                                                    ...
                                                                    int serializationPosition)
        {
            ...
            if (headerAttr is MessageHeaderArrayAttribute)
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxInvalidMessageHeaderArrayType"), defaultName)));
                }
            ...
            if (headerDescription.TypedHeader)
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxStaticMessageHeaderPropertiesNotAllowed"), defaultName)));
                }
            }
            else
            {
        ...
        private class SyncAsyncOperationConsistencyVerifier : OperationConsistencyVerifier
        {
            ...
            public override void VerifyParameterLength()
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                        new InvalidOperationException(Res.GetString(Res.S("SyncAsyncMatchConsistency_Parameters5"),
            ...
            public override void VerifyReturnType()
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                        new InvalidOperationException(Res.GetString(Res.S("SyncAsyncMatchConsistency_ReturnType5"),
                                                                   this.syncOperation.SyncMethod.Name,
                                                                   this.syncOperation.SyncMethod.DeclaringType,
                                                                   this.asyncOperation.BeginMethod.Name,
                                                                   this.asyncOperation.EndMethod.Name,
            ...
            public override void VerifyIsOneWayStatus()
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                            new InvalidOperationException(Res.GetString(Res.S("SyncAsyncMatchConsistency_Property6"),
                                                                       this.syncOperation.SyncMethod.Name,
                                                                       this.syncOperation.SyncMethod.DeclaringType,
                                                                       this.asyncOperation.BeginMethod.Name,
                                                                       this.asyncOperation.EndMethod.Name,
        ...
        private class SyncTaskOperationConsistencyVerifier : OperationConsistencyVerifier
        {
            ...
            public override void VerifyParameterLength()
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                        new InvalidOperationException(Res.GetString(Res.S("SyncTaskMatchConsistency_Parameters5"),
                                                                   this.syncOperation.SyncMethod.Name,
                                                                   this.syncOperation.SyncMethod.DeclaringType,
            ...
            public override void VerifyReturnType()
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                        new InvalidOperationException(Res.GetString(Res.S("SyncTaskMatchConsistency_ReturnType5"),
                                                                   this.syncOperation.SyncMethod.Name,
                                                                   this.syncOperation.SyncMethod.DeclaringType,
                                                                   this.taskOperation.TaskMethod.Name,
                                                                   this.syncOperation.Name)));
            ...
            public override void VerifyIsOneWayStatus()
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                            new InvalidOperationException(Res.GetString(Res.S("SyncTaskMatchConsistency_Property6"),
                                                                       this.syncOperation.SyncMethod.Name,
                                                                       this.syncOperation.SyncMethod.DeclaringType,
                                                                       this.taskOperation.TaskMethod.Name,
                                                                       this.syncOperation.Name,
        ...
        private class TaskAsyncOperationConsistencyVerifier : OperationConsistencyVerifier
        {
            ...
            public override void VerifyParameterLength()
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                        new InvalidOperationException(Res.GetString(Res.S("TaskAsyncMatchConsistency_Parameters5"),
                                                                   this.taskOperation.TaskMethod.Name,
            ...
            public override void VerifyReturnType()
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                        new InvalidOperationException(Res.GetString(Res.S("TaskAsyncMatchConsistency_ReturnType5"),
                                                                   this.taskOperation.TaskMethod.Name,
                                                                   this.taskOperation.TaskMethod.DeclaringType,
                                                                   this.asyncOperation.BeginMethod.Name,
                                                                   this.asyncOperation.EndMethod.Name,
            ...
            public override void VerifyIsOneWayStatus()
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                            new InvalidOperationException(Res.GetString(Res.S("TaskAsyncMatchConsistency_Property6"),
                                                                       this.taskOperation.TaskMethod.Name,
                                                                       this.taskOperation.TaskMethod.DeclaringType,
                                                                       this.asyncOperation.BeginMethod.Name,
                                                                       this.asyncOperation.EndMethod.Name,
