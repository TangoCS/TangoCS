...
namespace System.ServiceModel.Description
{
	...
	public class ClientCredentials : SecurityCredentialsManager, IEndpointBehavior
    {
        ...
        //        if (this.isReadOnly)
        //        {
        //            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("ObjectIsReadOnly"))));
        //        }
        ...
        public ClientCredentials Clone()
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotImplementedException(Res.GetString(Res.S("CloneNotImplementedCorrectly"), this.GetType(), (result != null) ? result.ToString() : "null")));
            }
            return result;
        }
        ...
        void IEndpointBehavior.AddBindingParameters(ServiceEndpoint serviceEndpoint, BindingParameterCollection bindingParameters)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("MultipleSecurityCredentialsManagersInChannelBindingParameters"), otherCredentialsManager)));
            }
        ...
        void IEndpointBehavior.ApplyDispatchBehavior(ServiceEndpoint serviceEndpoint, EndpointDispatcher endpointDispatcher)
        {
            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(
                Res.GetString(Res.S("SFXEndpointBehaviorUsedOnWrongSide"), typeof(ClientCredentials).Name)));
        }
