...
//        }
        ...
        //    {
        //        string text = Res.GetString(Res.S("SFxCannotRequireBothSessionAndDatagram3"), datagramContractName, sessionContractName, binding.Name);
        ...
        //                                                                  Res.GetString(Res.S("ServiceHasZeroAppEndpoints"), description.ConfigurationName)));
        //}
        ...
        //        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxEndpointNoMatchingScheme"), endpoint.Binding.Scheme, endpoint.Binding.Name, serviceHost.GetBaseAddressSchemes())));
        //    }
        //    return listenUri;
        //}
        ...
        //                    Res.GetString(Res.S("SFxReceiveContextSettingsPropertyMissing"),
        ...
        //            {
        //                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("ABindingInstanceHasAlreadyBeenAssociatedTo1"), viaString)));
        //            }
        ...
        //            {
        //                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(
        //                                                                              Res.GetString(Res.S("SFxWhenMultipleEndpointsShareAListenUriTheyMustHaveSameIdentity"), viaString)));
        //            }
        ...
        //                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("MsmqBatchRequiresTransactionScope"))));
        ...
        //                            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
        //                                new InvalidOperationException(
        //                                    Res.GetString(Res.S("SFxDuplicateInitiatingActionAtSameVia"),
        ...
        //            {
        //                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxRequiredRuntimePropertyMissing"), "InstanceContextProvider")));
        //            }
        //        }
        //    }
        //}
        ...
        static void BuildDispatchOperation(OperationDescription operation, DispatchRuntime parent, EndpointFilterProvider provider)
        {
            ...
            else
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(Res.GetString(Res.S("SFxMultipleContractStarOperations0"))));
                }
        ...
        class BindingInformationEndpointBehavior : IEndpointBehavior
        {
            ...
            bool IsManualAddressing(Binding binding)
            {
                ...
                if (transport == null)
                {
                    string text = Res.GetString(Res.S("SFxBindingMustContainTransport2"), binding.Name, binding.Namespace);
                    Exception error = new InvalidOperationException(text);
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(error);
                }
