...
namespace System.ServiceModel.Description
{
    ...
    public class OperationDescription
    {
        ...
        public OperationDescription(string name, ContractDescription declaringContract)
        {
            ...
            if (name.Length == 0)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                    new ArgumentOutOfRangeException("name", Res.GetString(Res.S("SFxOperationDescriptionNameCannotBeEmpty"))));
            }
        ...
        internal void EnsureInvariants()
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new System.InvalidOperationException(Res.GetString(Res.S("SFxOperationMustHaveOneOrTwoMessages"), this.Name)));
            }
        }
