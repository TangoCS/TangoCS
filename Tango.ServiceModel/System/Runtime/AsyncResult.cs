...
namespace System.Runtime
{
	...
	abstract class AsyncResult : IAsyncResult
	{
		...
		protected void Complete(bool completedSynchronously)
		{
			if (this.isCompleted)
			{
				throw Fx.Exception.AsError(new InvalidOperationException("AsyncResultCompletedTwice"));
			}
			...
			if (this.callback != null)
			{
				...
				catch (Exception e)
				{
					...
					throw Fx.Exception.AsError(new CallbackException(Rs.S("AsyncCallbackThrewException"), e));
				}
			}
		}
		...
		static void AsyncCompletionWrapperCallback(IAsyncResult result)
		{
			if (result == null)
			{
				throw Fx.Exception.AsError(new InvalidOperationException(Rs.S("InvalidNullAsyncResult")));
			}
			...
			where TAsyncResult : AsyncResult
		{
			...
			if (asyncResult == null)
			{
				throw Fx.Exception.Argument("result", Rs.S("InvalidAsyncResult"));
			}

			if (asyncResult.endCalled)
			{
				throw Fx.Exception.AsError(new InvalidOperationException(Rs.S("AsyncResultAlreadyEnded")));
			}
