...
namespace System.Runtime
{
	...
	static class Fx
	{
		...
		//[Fx.Tag.SecurityNote(Critical = "Accesses SecurityCritical field EtwProvider", Safe = "Doesn't leak info\\resources")]
		...
		public static byte[] AllocateByteArray(int size)
		{
			...
			catch (OutOfMemoryException exception)
			{
				...
				throw Fx.Exception.AsError(
					new InsufficientMemoryException("BufferAllocationFailed", exception));
			}
		}
		...
		class InternalException : SystemException
		{
			public InternalException(string description)
				: base("ShipAssertExceptionMessage")
			{
			}
