...
namespace System.Runtime
{
	...
	struct TimeoutHelper
	{
		...
		public static void ThrowIfNegativeArgument(TimeSpan timeout, string argumentName)
		{
			...
			{
				throw Fx.Exception.ArgumentOutOfRange(argumentName, timeout, Rs.GetString("TimeoutMustBeNonNegative", argumentName, timeout));
			}
		}
		...
		public static void ThrowIfNonPositiveArgument(TimeSpan timeout, string argumentName)
		{
			if (timeout <= TimeSpan.Zero)
			{
				throw Fx.Exception.ArgumentOutOfRange(argumentName, timeout, Rs.GetString("TimeoutMustBePositive", argumentName, timeout));
			}
		}
