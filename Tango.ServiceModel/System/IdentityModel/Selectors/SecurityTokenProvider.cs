...
namespace System.IdentityModel.Selectors
{
	...
	public abstract class SecurityTokenProvider
    {
        ...
        public SecurityToken GetToken(TimeSpan timeout)
        {
            ...
            if (token == null)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new SecurityTokenException(Res.GetString(Res.S("TokenProviderUnableToGetToken"), this)));
            }
            return token;
        }
        ...
        public SecurityToken RenewToken(TimeSpan timeout, SecurityToken tokenToBeRenewed)
        {
            ...
            if (token == null)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new SecurityTokenException(Res.GetString(Res.S("TokenProviderUnableToRenewToken"), this)));
        ...
        {
            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(Res.GetString(Res.S("TokenRenewalNotSupported"), this)));

		}

        protected virtual void CancelTokenCore(TimeSpan timeout, SecurityToken token)
        {
            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(Res.GetString(Res.S("TokenCancellationNotSupported"), this)));
        ...
        internal protected class SecurityTokenAsyncResult : IAsyncResult
        {
            ...
            public SecurityTokenAsyncResult(SecurityToken token, AsyncCallback callback, object state)
            {
                ...
                if (callback != null)
                {
                    ...
                    catch (Exception e)
                    {
                        ...
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperCallback(Res.GetString(Res.S("AsyncCallbackException")), e);
                    }
                }
            }
            ...
            public static SecurityToken End(IAsyncResult result)
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(Res.GetString(Res.S("InvalidAsyncResult")), "result"));
                }
