	...
	public class SecurityTokenRequirement
    {
        ...
        public int KeySize
        {
            ...
            set
            {
                if (value < 0)
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("value", Res.GetString(Res.S("ValueMustBeNonNegative"))));
                }
        ...
        public TValue GetProperty<TValue>(string propertyName)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(Res.GetString(Res.S("SecurityTokenRequirementDoesNotContainProperty"), propertyName)));
        ...
        public bool TryGetProperty<TValue>(string propertyName, out TValue result)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(Res.GetString(Res.S("SecurityTokenRequirementHasInvalidTypeForProperty"), propertyName, dictionaryValue.GetType(), typeof(TValue))));
