	...
	public class UserNameSecurityToken : SecurityToken
    {
        ...
        {   
            ...
            if (userName == string.Empty)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument(Res.GetString(Res.S("UserNameCannotBeEmpty")));
        ...
        {
            // Never expire
            get { return new DateTime(DateTime.MaxValue.Ticks - TimeSpan.TicksPerDay, DateTimeKind.Utc); }
        }
