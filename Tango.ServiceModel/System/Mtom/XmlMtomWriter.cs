...
namespace System.Xml
{
	...
	class XmlMtomWriter : XmlDictionaryWriter
	{
			...
			if (count > currSize - offset)
			{
				...
				do
				{
					if (newSize == Int32.MaxValue)
						throw new XmlException("WriteBufferOverflow");
