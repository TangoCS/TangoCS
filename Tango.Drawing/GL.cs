...
namespace Tango.Drawing
{
	public class GL
	{
		public const string Opengl = "osmesa";

		#region Imports

		public const int WGL_FONT_POLYGONS = 1;
		public const int GLF_START_LIST = 1000;
		...
		[DllImport(Opengl)]
		unsafe public static extern byte* glGetString(uint name);
		[DllImport(Opengl)]
		...
		[DllImport(Opengl)]
		public static extern void glCallLists(int n, uint type, [MarshalAs(UnmanagedType.LPStr)] string lists);
