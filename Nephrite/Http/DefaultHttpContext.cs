...
{
	public class DefaultHttpContext : AbstractHttpContext
	{
		private static IList<string> EmptyList = new List<string>();

		private readonly AbstractHttpRequest _request;
		private readonly AbstractHttpResponse _response;
		...
		public override AbstractHttpRequest Request { get { return _request; } }

		public override AbstractHttpResponse Response { get { return _response; } }
