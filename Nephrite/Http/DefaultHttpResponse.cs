...
{
	public class DefaultHttpResponse : AbstractHttpResponse
	{
		...
		public override AbstractHttpContext HttpContext { get { return _context; } }
		...
		public override void SignOut(string authenticationScheme, AuthenticationProperties properties)
        {
            ...
            var signOutContext = new SignOutContext(authenticationScheme, properties == null ? null : properties.Dictionary);
            if (handler != null)
            {
