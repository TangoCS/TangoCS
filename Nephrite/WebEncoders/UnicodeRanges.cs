...
namespace Nephrite.WebEncoders
{
    ...
    public static partial class UnicodeRanges
    {
        ...
        /// </summary>
        public static UnicodeRange None { get { return Volatile.Read(ref _none) ?? CreateEmptyRange(ref _none); } }
        ...
        /// </summary>
		public static UnicodeRange All { get { return Volatile.Read(ref _all) ?? CreateRange(ref _all, '\u0000', '\uFFFF'); } }
