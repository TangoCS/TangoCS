...
namespace Nephrite.Meta
{
	...
	//		{
	//			case "S": a.Type = TypeFactory.CustomString(xp.GetAttributeValue("Length").ToInt32(-1)); break;
	...
	//			case "M": a.Type = TypeFactory.CustomDecimal(xp.GetAttributeValue("Precision").ToInt32(14), xp.GetAttributeValue("Scale").ToInt32(6)); break;
	//			case "C": a.Type = new MetaEnumType { Name = xp.GetAttributeValue("EnumName") ?? "" }; break;
	//			case "F": a.Type = TypeFactory.FileIntKey; break;
	//			case "E": a.Type = TypeFactory.FileGuidKey; break;
 ...
 //				(AssociationType)xp.GetAttributeValue("AssociationType").ToInt32(0),
	...
	//				{
	//					case "string": parm.Type = TypeFactory.String; break;
	//					case "int": parm.Type = TypeFactory.Int; break;
	//					case "guid": parm.Type = TypeFactory.Guid; break;
	//				}
