...
namespace Tessera.ReplicationService {
    using System;
    ...
    public partial class Replication : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback GetObjectTransitionsOperationCompleted;
        ...
        /// <remarks/>
        public Replication() {
            this.Url = global::Tessera.Properties.Settings.Default.Tessera_Web_ReplicationService_Replication;
        ...
        /// <remarks/>
        public event GetObjectTransitionsCompletedEventHandler GetObjectTransitionsCompleted;
        ...
        /// <remarks/>
        public void ConfirmReplicationAsync(string objectType, string id, long ticks) {
            this.ConfirmReplicationAsync(objectType, id, ticks, null);
        }
        
        /// <remarks/>
        public void ConfirmReplicationAsync(string objectType, string id, long ticks, object userState) {
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapHeaderAttribute("UserCredentialsValue")]
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://nephritetech.com/tessera/integration/1.0/GetObjectTransitions", RequestNamespace="http://nephritetech.com/tessera/integration/1.0", ResponseNamespace="http://nephritetech.com/tessera/integration/1.0", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public ObjectTransition[] GetObjectTransitions(string objectType, string id) {
            object[] results = this.Invoke("GetObjectTransitions", new object[] {
                        objectType,
                        id});
            return ((ObjectTransition[])(results[0]));
        }
        
        /// <remarks/>
        public void GetObjectTransitionsAsync(string objectType, string id) {
            this.GetObjectTransitionsAsync(objectType, id, null);
        }
        
        /// <remarks/>
        public void GetObjectTransitionsAsync(string objectType, string id, object userState) {
            if ((this.GetObjectTransitionsOperationCompleted == null)) {
                this.GetObjectTransitionsOperationCompleted = new System.Threading.SendOrPostCallback(this.OnGetObjectTransitionsOperationCompleted);
            }
            this.InvokeAsync("GetObjectTransitions", new object[] {
                        objectType,
                        id}, this.GetObjectTransitionsOperationCompleted, userState);
        }
        
        private void OnGetObjectTransitionsOperationCompleted(object arg) {
            if ((this.GetObjectTransitionsCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.GetObjectTransitionsCompleted(this, new GetObjectTransitionsCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://nephritetech.com/tessera/integration/1.0")]
    public partial class ObjectTransition {
        ...
        private string workflowSysNameField;
        
        private string activitySysNameField;
        
        private string prevActivitySysNameField;
        
        private int objectTransitionIDField;
        ...
        /// <remarks/>
        public string WorkflowSysName {
            get {
                return this.workflowSysNameField;
            }
            set {
                this.workflowSysNameField = value;
            }
        }
        ...
        public string ActivitySysName {
            get {
                return this.activitySysNameField;
            }
            set {
                this.activitySysNameField = value;
            }
        }
        
        /// <remarks/>
        public string PrevActivitySysName {
            get {
                return this.prevActivitySysNameField;
            }
            set {
                this.prevActivitySysNameField = value;
            }
        }
        
        /// <remarks/>
        public int ObjectTransitionID {
            get {
                return this.objectTransitionIDField;
            }
            set {
                this.objectTransitionIDField = value;
            }
        }
    }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.17929")]
    public delegate void GetObjectTransitionsCompletedEventHandler(object sender, GetObjectTransitionsCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.17929")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class GetObjectTransitionsCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal GetObjectTransitionsCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
        
        /// <remarks/>
        public ObjectTransition[] Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((ObjectTransition[])(this.results[0]));
            }
        }
    }
