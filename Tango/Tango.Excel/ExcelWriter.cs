...
namespace Tango.Excel
{
	public class ExcelWriter : IContentWriter, IDisposable
	{
		...
		class TdAttributes : ITdAttributes
		{
			...
			public ITdAttributes Data<TValue>(string key, TValue value, bool replaceExisting = true)
			{
				return this;
			}
		}
		...
		class ThAttributes : IThAttributes
		{
			...
			public IThAttributes Data<TValue>(string key, TValue value, bool replaceExisting = true)
			{
				return this;
			}
		}
		...
		class CIAttributes : IContentItemAttributes
		{
			...
			public IContentItemAttributes Data<TValue>(string key, TValue value, bool replaceExisting = true)
			{
				return this;
			}
		}
