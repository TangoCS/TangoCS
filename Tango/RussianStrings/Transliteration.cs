...
namespace Tango.RussianStrings
{
	...
	public static class Transliteration
	{
		...
		public static string RusLat(string text)
		{
			 
			return RusLat(text, TransliterationType.ISO);
		}
		public static string RusLat(string text, TransliterationType type)
		{
			string output = text;
		...
		public static string LatRus(string text)
		{
			return LatRus(text, TransliterationType.ISO);
		}
		public static string LatRus(string text, TransliterationType type)
		{
			string output = text;
			Dictionary<string, string> tdict = GetDictionaryByType(type);
