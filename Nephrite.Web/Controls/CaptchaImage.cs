...
namespace Nephrite.Web.Controls
{
	...
	public class CaptchaImage
	{
		...
		public static bool Validate(HttpContext context, string actualValue)
		{
			string guid = context.Request.Form["captcha-guid"];
		...
		/// </returns>
		public static string Render(int height, int width)
		{
			...
			HttpRuntime.Cache.Add(
				...
				image,
				null,
				DateTime.Now.AddSeconds(Nephrite.Web.Controls.CaptchaImage.CacheTimeOut),
