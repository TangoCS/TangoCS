...
namespace Tango.UI
{
	...
	{
		public static void FormField(this LayoutWriter w, string name, string caption, Action content, GridPosition grid = null, bool isRequired = false, string description = null, bool isVisible = true, string hint = null, bool withCheck = false)
		{
			w.FormField(name, () => w.Write(caption), content, grid, isRequired, description != null ? () => w.Write(description) : (Action)null, isVisible, hint, withCheck);
		}
