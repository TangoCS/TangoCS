...
namespace Tango.UI
{
	...
	{
		public static void FormField(this LayoutWriter w, string name, string caption, Action content, GridPosition grid = null, bool isRequired = false, string description = null, bool isVisible = true, string hint = null, bool withCheck = false, bool isDisabled = false, bool disableCheck = false)
		{
			w.FormField(name, () => w.Write(caption), content, grid, isRequired, description != null ? () => w.Write(description) : (Action)null, isVisible, hint, withCheck, isDisabled, disableCheck);
		}
		...
		public static void FormFieldReadOnly<T, TValue>(this LayoutWriter w, IMetaProperty<T, TValue> prop, T model, GridPosition grid = null)
		{
			w.FormField(prop.Name, w.Resources.Caption(prop), () => w.Write(prop.GetStringValue(model)), grid, false, w.Resources.Description(prop));
		}

		public static void FormFieldReadOnly(this LayoutWriter w, IMetaProperty prop, string value, GridPosition grid = null)
		{
			w.FormField(prop.Name, w.Resources.Caption(prop), () => w.Write(value), grid, false, w.Resources.Description(prop));
		}

		public static void FormFieldReadOnly(this LayoutWriter w, string name, string caption, string value, GridPosition grid = null, string description = null, string hint = null)
		{
		...
		public static void FormFieldTextBox<T>(this LayoutWriter w, string name, string caption, T value, GridPosition grid = null, bool isRequired = false, string description = null, Action<InputTagAttributes> attributes = null)
		{
			w.FormField(name, caption, () => w.TextBox(name, value?.ToString(), a => a.Set(attributes)), grid, isRequired, description);
		}

		public static void FormFieldTextArea<T>(this LayoutWriter w, string name, string caption, T value, GridPosition grid = null, bool isRequired = false, string description = null, Action<TextAreaTagAttributes> attributes = null)
		{
		...
		public static void FormFieldCalendar(this LayoutWriter w, string name, string caption, DateTime? value, GridPosition grid = null, bool isRequired = false, string description = "", EnabledState enabled = EnabledState.Enabled, bool showTime = false)
		{
		...
		public static void FormFieldCheckBox(this LayoutWriter w, string name, string caption, bool value = false, GridPosition grid = null, bool isRequired = false, string description = "")
		{
			w.FormField(name, caption, () => w.CheckBox(name, value), grid, isRequired, description);
		}

		public static void FormFieldToggleSwitch(this LayoutWriter w, string name, string caption, bool value = false, GridPosition grid = null, bool isRequired = false, string description = "")
		{
		...
		public static void FormFieldDropDownList(this LayoutWriter w, string name, string caption, string value, IEnumerable<SelectListItem> items, Action<SelectTagAttributes> attributes = null, GridPosition grid = null)
		{
			w.FormField(name, caption, () => w.DropDownList(name, value, items, a => a.Set(attributes)), grid);
		}

		public static void FormFieldRadioButtonsList(this LayoutWriter w, string name, string caption, string value, IEnumerable<SelectListItem> items, Action<TagAttributes> attributes = null, GridPosition grid = null)
		{
			w.FormField(name, caption, () => w.RadioButtonList(name, value, items, a => a.Set(attributes)), grid);
		}

		public static void FormFieldCheckBoxList(this LayoutWriter w, string name, string caption, string[] value, IEnumerable<SelectListItem> items, Action<TagAttributes> attributes = null, GridPosition grid = null, string hint = null, Func<SelectListItem, Action<InputTagAttributes>> itemAttributes = null)
		{
	...
	public static class ApiResponseExtensions
	{
		...
		public static void SetContentBodyGrid(this ApiResponse response)
		{
			response.SetElementClass("contentbody", "grid60");
		}
	}
}
